...
public class Track_Point3D implements org.apache.thrift.TBase<Track_Point3D, Track_Point3D._Fields>, java.io.Serializable, Cloneable, Comparable<Track_Point3D> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("Track_Point3D");
  ...
  static {
    schemes.put(StandardScheme.class, new Track_Point3DStandardSchemeFactory());
    schemes.put(TupleScheme.class, new Track_Point3DTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(Track_Point3D.class, metaDataMap);
  }

  public Track_Point3D() {
  }
   ...
   */
  public Track_Point3D(Track_Point3D other) {
  ...
  public Track_Point3D deepCopy() {
    return new Track_Point3D(this);
  }
  ...
  public Track_Point3D setX(double x) {
    this.x = x;
    setXIsSet(true);
    return this;
  }
  ...
  public Track_Point3D setY(double y) {
    this.y = y;
    setYIsSet(true);
    return this;
  }
  ...
  public Track_Point3D setZ(double z) {
    this.z = z;
    setZIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof Track_Point3D)
      return this.equals((Track_Point3D)that);
    return false;
  }

  public boolean equals(Track_Point3D that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(Track_Point3D other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("Track_Point3D(");
    boolean first = true;
  ...
  private static class Track_Point3DStandardSchemeFactory implements SchemeFactory {
    public Track_Point3DStandardScheme getScheme() {
      return new Track_Point3DStandardScheme();
    }
  }

  private static class Track_Point3DStandardScheme extends StandardScheme<Track_Point3D> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Track_Point3D struct) throws TException {
      ...
      if (!struct.isSetZ()) {
        throw new TProtocolException("Required field 'z' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }

    public void write(org.apache.thrift.protocol.TProtocol oprot, Track_Point3D struct) throws TException {
      struct.validate();
  ...
  private static class Track_Point3DTupleSchemeFactory implements SchemeFactory {
    public Track_Point3DTupleScheme getScheme() {
      return new Track_Point3DTupleScheme();
    }
  }

  private static class Track_Point3DTupleScheme extends TupleScheme<Track_Point3D> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Track_Point3D struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Track_Point3D struct) throws TException {
